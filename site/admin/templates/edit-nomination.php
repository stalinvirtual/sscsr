                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" name="nomination_form" method="post" id="nomination_form"
                            ...
                            <div class="card-footer">
                                <input type="submit" class="btn btn-info" name="save-nomination" value="Submit" style="margin: 0px 0px 0px -160px;
}"
                                    id="save-namination">
                                <input type="button" class="btn btn-default float-right" onclick="history.back();" style="float: left !important;
    margin: 0px 0px 0px 310px;"  value="Cancel">
                            </div>
                            <!-- /.card-footer -->
                        </form>
